...
class Complex{
    ...
    public:
        ...
        //  Below line means that nom member  sum complex function is allowed
...
that class. c.sumComplex() == Invalid
3. Can be invoked without the help of any object
4. Usually contains the arguments 
5.  Can be declared inside public or private of the class
6.  It  cannot acccess the members directly by their name and need object name.membername to access any member
*/ 